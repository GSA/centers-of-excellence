...
<a href="{{site.baseurl}}/images/CoE Guide to AI Ethics.pdf" target="_blank" rel="noopener noreferrer">
<img src="{{site.baseurl}}/images/CoE Guide to AI Ethics.pdf" alt="Design-Develop-Deploy Cycle for AI Solutions">
