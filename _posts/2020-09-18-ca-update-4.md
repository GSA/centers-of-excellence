...
- Create cloud-adoption essentials checklist to document common services (e.g., IAM).
...
- Assess what kinds of technical approaches needed for your applications.
...
Best practices are not just about tools and technology, so it’s important to communicate to people about these new ways of working. 
...
<h3>{% include download_pdf.html download_title="Cloud Adoption Service Cataloge (PDF, 580 KB)"
    download_url="/docs/2020/CAServiceCatalog.pdff" %}</h3>
