...
Archives and Records Administration's (NARA) electronic records management mandate requires agencies shift to digital-only records 
submissions by 2022. In addition, while the  21st Century Integrated Digital Experience Act, requires digitization of non-digital 
and paper-based government services, it does not do away with paper forms and documents entirely. Agencies will have to adapt to 
effectively operate in a mixed analog-digital world, at least on the front-end. The Cloud Adoption Center of Excellence (CoE) is 
assisting agencies in implementing IDE solutions to reduce manual workloads, digitize paper records and enable automated processing 
of paper-based forms such as claims and applications. 
