...
You can see a full report of our work, including methods, resources, and other artifacts in the USDA Direct Farms Loan Journey Map. Our research revealed improvements that some service centers have already discovered and that need to be adapted and spread throughout the system. We also uncovered some relatively simple, low-cost solutions, that if skillfully applied at the right points of the loan process, could help relieve some of the biggest pain points faced by both producers and loan officers. For example, we're currently prototyping targeted digital and paper farm loan eligibility guides to help streamline the process for applicants, and help them better understand their entire loan journey with USDA, and the steps they need to take within it.
