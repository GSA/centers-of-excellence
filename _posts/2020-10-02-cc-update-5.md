...
<h3>{% include download_pdf.html download_title="Contact Center Playbook (PDF, 684 KB)"
    download_url="docs/2020/Contact Center Playbook-Oct-2020.pdf" %}</h3>
...
<h3>{% include download_pdf.html download_title="Emerging Technologies in Contact Centers (PDF, 967 KB)"
    download_url="docs/docs/Emerging-Tech-Contact-Center-White-Paper.pdf" %}</h3>    
