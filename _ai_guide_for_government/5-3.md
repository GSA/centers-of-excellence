...
<!-- ## Organizational & Operational Maturity
Copy to come from Meghan
{: .intro}

<table class="ai-ops-maturity-table">
<thead>
  <tr>
    <td></td>
    <th class="level-1">Level 1 <br>(Initial / Ad Hoc Individual Project)</th>
    <th class="level-2">Level 2 <br>(Repeatable Team Project)</th>
    <th class="level-3">Level 3 <br>(Defined Program) </th>
    <th class="level-4">Level 4 <br>(Managed Portfolio)</th>
    <th class="level-5">Level 5 <br>(Optimized Enterprise)</th>
  </tr>
</thead>
<tbody>
  <tr>
